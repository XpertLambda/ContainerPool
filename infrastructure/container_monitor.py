...
def check_pool_health():
    """
    Check pool containers and report any issues
    """
    try:
        ...
        logger.info(f"Pool Status: {available} available, {assigned} assigned, {stopped} stopped")
        
        if stopped > 0:
            logger.warning(f"⚠ {stopped} pool containers are not running!")
...
if __name__ == '__main__':
    try:
        ...
        # Check and recover user containers
